    ...
    <>
      <main>
        <div className="images">
          ...
          <img id='msi-chicago' src="/MSI-Chiago.png" alt="" />
          <img id='phone' src="/louise's-phone.png" alt="" />
          <img id='kikk' src="/KIKK-Festival.png" alt="" />
          <img id='kennedy' src="/Kennedy-center.png" alt="" />
          <img id='opera' src="/Royal-opera.png" alt="" />
        </div>
